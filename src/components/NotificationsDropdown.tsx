...
export default function NotificationsDropdown() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>(() => {
    try {
      const saved = localStorage.getItem("nuvyra_notifications");
  ...
  useEffect(() => {
    localStorage.setItem("nuvyra_notifications", JSON.stringify(notifications));
  }, [notifications]);
